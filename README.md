...
Browser automation uses Playwright Core with the Chromium package supplied by each Docker architecture, avoiding bundled browser downloads that are unavailable for some supported ARM platforms.
